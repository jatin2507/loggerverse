...
describe('Console Override', () => {
    ...
    describe('Parameter Handling', () => {
        ...
        it('should handle non-string messages', () => {
            ...
            expect(mockTransport.log).toHaveBeenNthCalledWith(1, expect.objectContaining({ message: '123' }));
            expect(mockTransport.log).toHaveBeenNthCalledWith(2, expect.objectContaining({ message: 'true' }));
            expect(mockTransport.log).toHaveBeenNthCalledWith(3, expect.objectContaining({ message: 'null' }));
        });
    });
...
//# sourceMappingURL=console-override.test.js.map